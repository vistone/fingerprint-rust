...
pub fn chrome_103() -> ClientProfile {
    ...
    ClientProfile::new(
        ClientHelloID::new("Chrome", "103", crate::tls_config::chrome_103_spec),
        settings,
        settings_order,
...
pub fn chrome_133() -> ClientProfile {
    let (settings, settings_order) = chrome_http2_settings();
    ClientProfile::new(
        ClientHelloID::new("Chrome", "133", crate::tls_config::chrome_133_spec),
        settings,
        settings_order,
        chrome_pseudo_header_order(),
        crate::http2_config::CHROME_CONNECTION_FLOW,
...
pub fn firefox_133() -> ClientProfile {
    ...
    ClientProfile::new(
        ClientHelloID::new("Firefox", "133", crate::tls_config::firefox_133_spec),
        settings,
        settings_order,
...
pub fn safari_16_0() -> ClientProfile {
    ...
    ClientProfile::new(
        ClientHelloID::new("Safari", "16.0", crate::tls_config::safari_16_0_spec),
        settings,
        settings_order,
...
pub fn opera_91() -> ClientProfile {
    ...
    let (settings, settings_order) = chrome_http2_settings();
    ClientProfile::new(
        ClientHelloID::new("Opera", "91", crate::tls_config::chrome_133_spec), // Opera 使用 Chrome 的 TLS 配置
        settings,
        settings_order,
        chrome_pseudo_header_order(),
        crate::http2_config::CHROME_CONNECTION_FLOW,
