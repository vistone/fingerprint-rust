...
mod security_tests {
    ...
    fn test_ihl_causing_overflow() {
        ...
        assert!(
            result.is_err(),
            "shouldrefuse header_len exceed packet lengthcountpacket"
        );
    }
    ...
    fn test_valid_minimal_ipv4_packet() {
        ...
        assert!(
            result.is_ok(),
            "validminimum IPv4 countpacketshouldParsesuccess"
        );
    }
    ...
    fn test_invalid_tcp_data_offset_zero() {
        ...
        assert!(
            result.is_err(),
            "shouldrefuse data_offset = 0 TCP countpacket"
        );
    }
    ...
    fn test_invalid_tcp_data_offset_small() {
        ...
        assert!(
            result.is_err(),
            "shouldrefuse data_offset < 5 TCP countpacket"
        );
    }
