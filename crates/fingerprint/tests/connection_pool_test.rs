...
fn test_connection_pool_multiple_hosts() {
    ...
    let urls = [
        ...
        "http:// example.com/", // 重复，应该复用connect
    ];
...
fn test_connection_pool_not_enabled() {
    // 如果未enable connection-pool functionality，这个testing会through
